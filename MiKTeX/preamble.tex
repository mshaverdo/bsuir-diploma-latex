...
\newcommand{\sect}[3]{\refstepcounter{section}\setcounter{page}{#3}%
  \addcontentsline{toc}{section}{\protect\numberline{#1}#2}%
  \null\clearpage}
\newcommand{\ssect}[3]{\refstepcounter{section}\setcounter{page}{#3}%
...
\lstdefinestyle{pythonstyle}{
   xleftmargin=0ex,
   language=Python,
%    basicstyle=\fontsize{12}{12}\fontfamily{couriernew}\selectfont,
   basicstyle=\ttfamily\fontsize{12}{12}\selectfont,
   breaklines=true,
